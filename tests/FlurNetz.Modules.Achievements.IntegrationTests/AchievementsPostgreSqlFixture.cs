...
/// <summary>
/// Verwaltet eine isolierte PostgreSQL-Testdatenbank für den Achievements-Vertical-Slice.
/// </summary>
/// <remarks>
/// Die Tests verwenden echtes PostgreSQL für Constraints, Foreign Keys und konkurrierende
/// Composite-Key-Inserts. Ohne Docker kann eine isolierte Datenbank über
/// <c>FLURNETZ_TEST_CONNECTION_STRING</c> bereitgestellt werden.
/// </remarks>
public sealed class AchievementsPostgreSqlFixture : IAsyncLifetime
{
    ...
    public string ConnectionString => connectionString
        ?? throw new InvalidOperationException(
            "The PostgreSQL test infrastructure is unavailable.");

    public async ValueTask InitializeAsync()
    {
        var configuredConnectionString = Environment.GetEnvironmentVariable(
            "FLURNETZ_TEST_CONNECTION_STRING");
        ...
        {
            SkipReason =
                "Docker is unavailable; set FLURNETZ_TEST_CONNECTION_STRING to a PostgreSQL "
                + "test database to run these tests.";
            IsAvailable = false;
