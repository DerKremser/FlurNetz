...
/// <summary>
/// Verwaltet eine isolierte PostgreSQL-Testdatenbank für den Cross-Module-Workflow.
/// </summary>
/// <remarks>
/// Der Workflow wird gegen echtes PostgreSQL geprüft, weil Outbox-/Inbox-Transaktionen,
/// JSONB und die Progression-Zeilensperre nicht durch eine In-Memory-Alternative ersetzt
/// werden sollen. Ohne Docker kann eine isolierte Datenbank über
/// <c>FLURNETZ_TEST_CONNECTION_STRING</c> bereitgestellt werden.
/// </remarks>
public sealed class WorkflowPostgreSqlFixture : IAsyncLifetime
{
