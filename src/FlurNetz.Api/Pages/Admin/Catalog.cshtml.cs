...
public sealed class CatalogModel(
    ...
    IRewardCatalogStore rewards) : PageModel
{
    ...
    public async Task OnGetAsync(CancellationToken token)
    {
        ...
        if (achievementTask.IsFaulted || titleTask.IsFaulted || rewardTask.IsFaulted || packageTask.IsFaulted) Error = "Ein oder mehrere Katalogbereiche sind momentan nicht verfügbar.";
    }
