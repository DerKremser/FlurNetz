...
Unread Count und identity-isolierter Keyset-Pagination. `Notifications.Contracts` bleibt leer;
die HTTP-Grenze verwendet API-eigene DTOs. Notification-Insert und Messaging-Inbox-Eintrag
