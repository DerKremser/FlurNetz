...
und verhindern eine Überziehung. Der Zustand startet bei null. Eine konkrete Währungsbezeichnung,
Multi-Currency, Persistence, Use Cases, Messaging, Events, Transfers, Rewards, Shop und API sind
noch nicht Bestandteil der Economy-Foundation.
